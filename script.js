$(document).ready(function() {
  const apiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-llgzp9.mo2.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://kodilla-tasks-prod-kodilla-tasks-llgzp9.mo2.mogenius.io/v1/trello';
